...
pub fn Dashboard() -> impl IntoView {
    ...
    let suggestions_icon = create_memo(move |_| "light-bulb");
    ...
    let handle_refresh = move |_| {
        ...
        spawn_local(async move {
            ...
            if let Ok(passwords) =
                serde_wasm_bindgen::from_value::<Vec<TableCheckItemArgs>>(response)
            {
                set_passwords.set(passwords);
            }
            set_is_loading.set(false);
                        ...
                        <div class="flex-1 overflow-y-auto">
                                    ...
                                    <div class="flex flex-col items-center">
                                        <div class="relative w-40 h-40">
                                            <div class="absolute inset-0 rounded-full border-8 border-gray-600"></div>
                                                <svg class="w-full h-full -rotate-90 transform rotate-180" viewBox="0 0 100 100">
                                                    <circle
                                                    ...
                                                    />
                                                    <circle
                                                        class="stroke-primary-100 fill-none"
                                                        cx="50"
                                                        cy="50"
                                                        r="45"
                                                        stroke-width="8"
                                                        stroke-dasharray="283"
                                                        style=move || format!("stroke-dashoffset: {}",
                                                            283.0 - (283.0 * average_score.get() as f32 / 100.0))
                                        ...
                                        <h3 class="mt-4 text-lg text-primary-100 font-semibold">"Gesamt Score"</h3>
                                    </div>
                                </div>

                                <div class="bg-background p-6 rounded-lg border border-gray-600">
                                    <h3 class="text-lg text-primary-100 font-semibold mb-4">"Status"</h3>
                                    <div class="space-y-4">
                            ...
                            <div class="bg-background rounded-lg border border-gray-600">
                                <div class="p-4 border-b border-gray-600 flex justify-between items-center">
                                    <h3 class="text-lg font-semibold text-primary-100">"Passwort Analyse"</h3>
                                    <div class="relative">
                                        <button
                                    ...
                                    <table class="w-full">
                                        <thead class="bg-background sticky top-0">
                                            <tr class="border-b border-gray-600">
                                                ...
                                                <th class="text-left p-4 text-gray-400 font-medium">
                                                    <div class="flex items-center">
                                                        <Icon icon=suggestions_icon.into() class="w-4 h-4 mr-2" />
                                                        "Vorschläge"
                                                    </div>
                                                </th>
                                                <th class="text-left p-4 text-gray-400 font-medium">
                                        ...
                                        <tbody class="divide-y divide-gray-600 overflow-auto">
